function varargout = dveGUI_controller(varargin)
...
% Last Modified by GUIDE v2.5 03-Aug-2011 11:57:50
...
% set(uicontrol(handles.etxt_phi),'String', handles.mvab_phi);
% set(uicontrol(handles.etxt_theta),'String', handles.mvab_theta);
% set(uicontrol(handles.txt_theta),'String',num2str(handles.mvab_theta));
...
% hObject    handle to etxt_theta (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of etxt_theta as text
%        str2double(get(hObject,'String')) returns contents of etxt_theta as a double
