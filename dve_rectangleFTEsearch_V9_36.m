function varargout = dve_rectangleFTEsearch_V9_36(varargin)
% DVE_RECTANGLEFTESEARCH_V9_36 MATLAB code for dve_rectangleFTEsearch_V9_36.fig
%      DVE_RECTANGLEFTESEARCH_V9_36, by itself, creates a new DVE_RECTANGLEFTESEARCH_V9_36 or raises the existing
%      singleton*.
%
%      H = DVE_RECTANGLEFTESEARCH_V9_36 returns the handle to a new DVE_RECTANGLEFTESEARCH_V9_36 or the handle to
%      the existing singleton*.
%
%      DVE_RECTANGLEFTESEARCH_V9_36('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DVE_RECTANGLEFTESEARCH_V9_36.M with the given input arguments.
%
%      DVE_RECTANGLEFTESEARCH_V9_36('Property','Value',...) creates a new DVE_RECTANGLEFTESEARCH_V9_36 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dve_rectangleFTEsearch_V9_36_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dve_rectangleFTEsearch_V9_36_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dve_rectangleFTEsearch_V9_36

% Last Modified by GUIDE v2.5 25-May-2012 15:21:34

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dve_rectangleFTEsearch_V9_36_OpeningFcn, ...
                   'gui_OutputFcn',  @dve_rectangleFTEsearch_V9_36_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before dve_rectangleFTEsearch_V9_36 is made visible.
function dve_rectangleFTEsearch_V9_36_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dve_rectangleFTEsearch_V9_36 (see VARARGIN)

% Choose default command line output for dve_rectangleFTEsearch_V9_36
...
% UIWAIT makes dve_rectangleFTEsearch_V9_36 wait for user response (see UIRESUME)
% uiwait(handles.fig1);


% --- Outputs from this function are returned to the command line.
function varargout = dve_rectangleFTEsearch_V9_36_OutputFcn(hObject, eventdata, handles) 
