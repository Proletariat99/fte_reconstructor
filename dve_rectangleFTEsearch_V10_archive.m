...
% Last Modified by GUIDE v2.5 24-May-2012 17:18:45
...
%     xpct = [0.2 vlm/wlx+0.2];
%     ypct = [0.1 0.1];
    % txtarr = annotation('textarrow',xpct,ypct,'String','We are here.','FontSize',14, 'FontColor','White');
    % -----------
    axis equal
